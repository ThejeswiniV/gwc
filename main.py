...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://gwcuser:gwcuser@34.93.9.124/gwcpmp"
engine = create_engine('mysql+pymysql://gwcuser:gwcuser@34.93.9.124/gwcpmp')
db = SQLAlchemy(app)
